...
jdbc_df.selectExpr(
    ...
    "topic", "svitlana_savchenko_athlete_event_results"
).save()
...
kafka_streaming_df = (
    ...
    .option("subscribe", "svitlana_savchenko_athlete_event_results")
...
def foreach_batch_function(df, epoch_id):
    ...
    df.selectExpr(
        ...
        "topic", "svitlana_savchenko_enriched_athlete_avg"
    ).save()
    ...
    df.write.format("jdbc").options(
        ...
        driver=jdbc_config["driver"],
        dbtable="svitlana_savchenko_enriched_athlete_avg",
        user=jdbc_config["user"],
        password=jdbc_config["password"],
    ).mode("append").save()
